...
/* I am placing all of the tests within the $() function,
    ...
    */
    ...
    describe('The menu', function(){
        ...
        /* a test that ensures the menu changes
          ...
          */
        it('is not hidden when clicked', function(){
    ...
    describe('Initial Entries', function(){
        ...
        it('has an entry element', function(){
    ...
    describe('New Feed Selection', function(){
        ...
        beforeEach(function(done) {
            loadFeed(1, function(){
                firstFeed = $('.feed').find('.entry-link').attr('href');
                done();
            });
        });
